...
export const BIN_CATALOG: BinCatalogItem[] = [
  ...
  {
    id: "temporary_10_yard",
    serviceType: "temporary",
    binSize: "10_yard",
    binType: "roll_off",
    size: "10-Yard",
    type: "Roll-Off",
    description: "10 cubic yards",
    priceRange: "$280–380",
    priceUnit: "week",
    bestFor: "Small cleanouts, bathroom remodels, deck removal",
    estimateCents: 33000,
  },
  {
    ...
    priceRange: "$350–480",
    priceUnit: "week",
    bestFor: "Medium renovations, roofing, landscaping projects",
    estimateCents: 41500,
  },
  {
    id: "temporary_30_yard",
    serviceType: "temporary",
    binSize: "30_yard",
    binType: "roll_off",
    size: "30-Yard",
    type: "Roll-Off",
    description: "30 cubic yards",
    priceRange: "$420–570",
    priceUnit: "week",
    bestFor: "Large construction, home additions, commercial cleanouts",
    estimateCents: 49500,
  },
  {
    id: "temporary_40_yard",
    serviceType: "temporary",
    binSize: "40_yard",
    binType: "roll_off",
    size: "40-Yard",
    type: "Roll-Off",
    description: "40 cubic yards",
    priceRange: "$490–650",
    priceUnit: "week",
    bestFor: "Major demolitions, new construction, large commercial jobs",
    estimateCents: 57000,
  },
  // Permanent service (monthly)
  {
    ...
    priceRange: "$120–180",
    priceUnit: "mo",
    bestFor: "Small businesses, restaurants, offices",
    estimateCents: 15000,
  },
  {
    id: "permanent_4_yard",
    ...
    size: "4-Yard",
    type: "Front-Load",
    description: "4 cubic yards",
    priceRange: "$160–240",
    priceUnit: "mo",
    bestFor: "Mid-size retail, apartment buildings",
    estimateCents: 20000,
  },
  {
    id: "permanent_6_yard",
    ...
    size: "6-Yard",
    type: "Front-Load",
    description: "6 cubic yards",
    priceRange: "$200–300",
    priceUnit: "mo",
    bestFor: "Large retail, multi-tenant buildings",
    estimateCents: 25000,
  },
  {
    id: "permanent_8_yard",
    ...
    size: "8-Yard",
    type: "Front-Load",
    description: "8 cubic yards",
    priceRange: "$250–360",
    priceUnit: "mo",
    bestFor: "High-volume commercial, grocery stores",
    estimateCents: 30500,
  },
  {
    id: "permanent_10_yard_perm",
    serviceType: "permanent",
    binSize: "10_yard_perm",
    binType: "open_top",
    size: "10-Yard",
    type: "Open-Top",
    description: "10 cubic yards",
    priceRange: "$310–450",
    priceUnit: "mo",
    bestFor: "Light industrial, warehouses",
    estimateCents: 38000,
  },
  {
    id: "permanent_20_yard_perm",
    serviceType: "permanent",
    binSize: "20_yard_perm",
    binType: "open_top",
    size: "20-Yard",
    type: "Open-Top",
    description: "20 cubic yards",
    priceRange: "$380–540",
    priceUnit: "mo",
    bestFor: "Manufacturing, distribution centers",
    estimateCents: 46000,
  },
  {
    id: "permanent_30_yard_perm",
    serviceType: "permanent",
    binSize: "30_yard_perm",
    binType: "open_top",
    size: "30-Yard",
    type: "Open-Top",
    description: "30 cubic yards",
    priceRange: "$460–640",
    priceUnit: "mo",
    bestFor: "Large industrial, construction companies",
    estimateCents: 55000,
  },
  {
    id: "permanent_40_yard_perm",
    serviceType: "permanent",
    binSize: "40_yard_perm",
    binType: "compactor",
    size: "40-Yard",
    type: "Compactor",
    description: "Compactor unit",
    priceRange: "$580–800",
    priceUnit: "mo",
    bestFor: "High-volume waste, large commercial operations",
    estimateCents: 69000,
  },
];
...
function findCatalogItem(
  serviceType: string,
  binSize: string,
): BinCatalogItem | undefined {
  return BIN_CATALOG.find(
    (b) => b.serviceType === serviceType && b.binSize === binSize,
  );
}
...
router.patch("/bin-orders/:id", requireAuth, async (req, res) => {
  ...
  if (["delivered", "picked_up", "cancelled"].includes(existing.status)) {
    res.status(400).json({
      error: "Cannot edit an order that's already been delivered or closed",
    });
    return;
  }
...
> = {
  confirmed: {
    type: "bin_confirmed",
    describe: (bin) =>
      `Your ${bin} bin order is confirmed — we're scheduling delivery.`,
  },
  delivered: {
    type: "bin_delivered",
    describe: (bin) =>
      `Your ${bin} bin has been delivered and is ready to use.`,
  },
  picked_up: {
    type: "bin_picked_up",
    describe: (bin) =>
      `Your ${bin} bin has been picked up. Thanks for using HaulBrokr!`,
  },
  cancelled: {
    type: "bin_cancelled",
