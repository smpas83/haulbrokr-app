...
router.patch("/bids/:id", requireProfile, async (req, res): Promise<void> => {
  ...
  if (parsed.data.status === "accepted") {
    ...
    await db.insert(jobsTable).values({
      ...
      facilityCoordinates: request.facilityCoordinates,
      facilityInstructions: request.facilityInstructions,
      facilityAcceptedMaterials: request.facilityAcceptedMaterials,
      facilitySafetyNotes: request.facilitySafetyNotes,
      facilityOperatingHours: request.facilityOperatingHours,
      facilityPricingMetadata: request.facilityPricingMetadata,
      facilityPhone: request.facilityPhone,
      brokerNotes: request.brokerNotes,
      driverInstructions: request.driverInstructions,
      notes: request.notes,
    });
