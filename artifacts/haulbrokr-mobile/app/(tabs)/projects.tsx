        ...
        {isError && (
          ...
          >
            ...
            <Text style={[styles.errorText, { color: "#ef4444" }]}>
              Could not load projects. Pull to refresh.
            </Text>
          </View>
        )}
                ...
                {project.totalBudget ? (
                  <View style={styles.budgetSection}>
                    <View style={styles.budgetRow}>
                      ...
                      <Text
                        style={[styles.budgetPct, { color: colors.primary }]}
                      >
                        {progress}%
                      </Text>
                    </View>
                    ...
                    <View style={styles.budgetAmounts}>
                      <Text
                        style={[styles.budgetAmt, { color: colors.foreground }]}
                      >
                  ...
                  <Text
                    style={[styles.noBudget, { color: colors.mutedForeground }]}
                  >
                    No budget set
                  </Text>
                )}
          ...
          >
            ...
            {[
              {
                ...
                value: name,
                set: setName,
                placeholder: "e.g. Downtown Demolition",
            ...
            <Pressable
              ...
              style={[
                ...
                createProject.isPending && { opacity: 0.6 },
              ]}
