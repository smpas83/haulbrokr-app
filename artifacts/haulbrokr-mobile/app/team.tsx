      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.emptyWrap}>
          ...
          <Text style={styles.emptyTitle}>
            You're a {ROLE_LABEL[profile.role]}
          </Text>
          <Text style={styles.emptyBody}>
            Team management is available to the company owner. Ask your manager
            if you need to invite someone.
          </Text>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.inviteCard}>
          <View style={styles.sourceRow}>
            ...
            <View
              style={[
                styles.sourcePill,
                {
                  backgroundColor: usingLive ? "#5fb87822" : "#8ba0b822",
                  borderColor: usingLive ? "#5fb87866" : "#8ba0b866",
                },
              ]}
            >
              <View
                style={[
                  styles.sourceDot,
                  { backgroundColor: usingLive ? "#5fb878" : "#8ba0b8" },
                ]}
              />
              <Text
                style={[
                  styles.sourcePillText,
                  { color: usingLive ? "#5fb878" : "#8ba0b8" },
                ]}
              >
          ...
          <Text style={styles.inviteHint}>
            Share this with {memberType} you want to invite. They enter it
            during signup.
          </Text>
          <View style={styles.inviteActions}>
            ...
            <Pressable
              style={[
                ...
                rotateMut.isPending && { opacity: 0.6 },
              ]}
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statCard}>
            <Text style={[styles.statValue, { color: "#5fb878" }]}>
              {activeCount}
            </Text>
        ...
        {isLoading && !liveMembers ? (
          <View style={styles.emptyList}>
            <ActivityIndicator color="#8ba0b8" />
          </View>
        ) : members.length === 0 ? (
          <View style={styles.emptyList}>
            ...
            <Text style={styles.emptyListSub}>
              Share your code above to invite them.
            </Text>
          </View>
        ) : (
          members.map((m) => (
            <View key={m.id} style={styles.memberCard}>
              <View
                style={[
                  styles.avatar,
                  {
                    backgroundColor: `${ROLE_COLOR[m.role]}22`,
                    borderColor: `${ROLE_COLOR[m.role]}66`,
                  },
                ]}
              >
                <Text
                  style={[styles.avatarText, { color: ROLE_COLOR[m.role] }]}
                >
                  {(m.name || "?")
                    .split(" ")
                    .map((p) => p[0])
              ...
              <View style={{ flex: 1 }}>
                <View style={styles.memberHeader}>
                  ...
                  <View
                    style={[
                      styles.statusDot,
                      { backgroundColor: m.active ? "#5fb878" : "#6b7280" },
                    ]}
                  />
                </View>
        ...
        {!usingLive && !isLoading && (
          <Text style={styles.footnote}>
            Showing demo data — sign in to see your real team and live invite
            code.
          </Text>
        )}
