...
export default function PaymentMethodScreen() {
  ...
  const pm = pmQuery.data as
    | { cardBrand?: string; cardLast4?: string; methodType?: string }
    | null
    | undefined;
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        {pmQuery.isLoading ? (
          ...
          >
            Add a card to pay for completed jobs. You can also pay per job via
            Stripe Checkout without saving a card.
          </Text>
        )}
