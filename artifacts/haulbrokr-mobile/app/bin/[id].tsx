    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.centerBox}>
          ...
          <Pressable
            onPress={() => router.replace("/(tabs)/bins")}
            style={{
      ...
      >
            ...
            LIFECYCLE.map((step, idx) => {
              ...
              return (
                <View key={step.key} style={styles.stepRow}>
                    ...
                    {!isLast && (
                      <View
                        style={[
                          ...
                          {
                            backgroundColor:
                              idx < currentIdx ? "#16a34a66" : colors.border,
                          },
                        ]}
                      />
                    )}
                  ...
                  <View
                    style={[styles.stepContent, isLast && { paddingBottom: 0 }]}
                  >
        ...
        >
          ...
          <DetailRow
            ...
            value={
              PROVIDER_LABEL[(order as any).preferredProvider ?? "any"] ??
              "Best Available"
            }
            colors={colors}
          />
