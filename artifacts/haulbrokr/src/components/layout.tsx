  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 flex flex-col overflow-hidden min-w-0">
        {/* Mobile Header */}
        <header className="h-14 bg-sidebar border-b border-sidebar-border flex items-center justify-between px-4 md:hidden sticky top-0 z-40 gap-2">
        ...
        {/* Desktop top bar */}
        <div className="hidden md:flex items-center gap-3 px-6 py-3 border-b border-border/60 bg-background/80 backdrop-blur-sm sticky top-0 z-30">
          <GlobalSearch className="max-w-sm flex-1" />
          <NotificationBell />
        </div>

        {/* Mobile search bar */}
        <div className="md:hidden px-4 py-2 border-b border-border/40 bg-background">
