      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          },
          {
            ...
            label: "Open Requests",
            value:
              isCustomer && stats?.openRequests != null
                ? String(stats.openRequests)
                : isProvider
                  ? "—"
                  : "—",
            color: "text-primary",
          ...
          {
            icon: TrendingUp,
            label: isProvider ? "Pending Bids" : "Completed",
            value: isProvider
              ? stats?.pendingBids != null
                ? String(stats.pendingBids)
                : "—"
          ...
          {
            icon: Sparkles,
            label: isProvider ? "Est. Revenue" : "Total Spent",
            value: isProvider
