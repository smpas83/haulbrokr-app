            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      >
                        <Building2 className={`w-8 h-8 mb-4 ${field.value === "customer" ? "text-primary" : "text-muted-foreground"}`} />
                        <h3 className="font-bold text-lg mb-2">I need trucks</h3>
                        <p className="text-sm text-muted-foreground">
                          I manage construction sites and need to hire dump trucks for hauling material.
                        </p>
                      </div>
                      ...
                      >
                        <Truck className={`w-8 h-8 mb-4 ${field.value === "provider" ? "text-primary" : "text-muted-foreground"}`} />
                        <h3 className="font-bold text-lg mb-2">I have trucks</h3>
                        <p className="text-sm text-muted-foreground">
              ...
              {selectedRole && (
                <div className="space-y-8 pt-4 border-t border-border animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="md:col-span-2">
                            <FormLabel>
                              {isProvider ? "Trucking Company" : "Company Name"} <span className="text-destructive">*</span>
                            </FormLabel>
                            <FormControl>
                              <Input placeholder={isProvider ? "MW Hauling LLC" : "Acme Construction"} {...field} className="h-12 bg-background" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="Doing business as…" {...field} className="h-12 bg-background" />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="https://…" {...field} className="h-12 bg-background" />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="ops@company.com" {...field} className="h-12 bg-background" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="123 Main St" {...field} className="h-12 bg-background" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Austin" {...field} className="h-12 bg-background" />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="TX" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="78701" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                  ...
                  {isProvider && (
                    <div className="space-y-4">
                      <h3 className="font-semibold text-lg">Carrier & Equipment</h3>
                      <p className="text-sm text-muted-foreground -mt-2">
                        Authority and capacity help us match you to the right loads.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                          control={form.control}
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="MC-123456" {...field} className="h-12 bg-background font-mono" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Travis, Williamson, Hays" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="number" inputMode="decimal" placeholder="20" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel>Capacity (cubic yards)</FormLabel>
                              <FormControl>
                                <Input type="number" inputMode="decimal" placeholder="16" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="number" inputMode="decimal" placeholder="125" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormDescription>Your full work value. HaulBrokr's fee is added on top for customers.</FormDescription>
                              <FormMessage />
                            </FormItem>
                          )}
                        />
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="number" inputMode="numeric" placeholder="4" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        render={({ field }) => {
                          ...
                          return (
                            <FormItem>
                              ...
                              <FormDescription>
                                Select every truck and machine type you run. We use this to match you to compatible loads.
                              </FormDescription>
                  ...
                  {!isProvider && (
                    <div className="space-y-4">
                      <h3 className="font-semibold text-lg">Billing & Accounts Payable</h3>
                      <p className="text-sm text-muted-foreground -mt-2">
                        Used for invoicing. Net terms require an approved credit application.
                      </p>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <FormField
                          control={form.control}
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input maxLength={4} placeholder="1234" {...field} className="h-12 bg-background font-mono" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="Accounts Payable" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input placeholder="ap@company.com" {...field} className="h-12 bg-background" />
                              </FormControl>
                              <FormMessage />
                            </FormItem>
                          )}
