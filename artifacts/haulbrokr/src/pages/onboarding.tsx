                    ...
                    <FormItem className="space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <p className="text-sm text-muted-foreground">
                            I drive dump trucks for a fleet or contractor and
                            need my assigned jobs.
                          </p>
                        </div>
                        ...
                        >
                          <User
                            className={`w-8 h-8 mb-4 ${field.value === "supervisor" ? "text-primary" : "text-muted-foreground"}`}
                          />
                          <h3 className="font-bold text-lg mb-2">
                            I&apos;m a supervisor
                          </h3>
                          <p className="text-sm text-muted-foreground">
                            I manage job sites and coordinate drivers for a
