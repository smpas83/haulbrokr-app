                        ...
                        {[
                          {
                            ...
                            icon: Building2,
                            title: "I need trucks",
                            desc: "I manage construction sites and need to hire dump trucks for hauling material.",
                          },
                          {
                            value: "provider" as const,
                            icon: Truck,
                            title: "I have trucks",
                            desc: "I operate a fleet of dump trucks and want to find active hauling jobs.",
                          },
                          {
                            value: "driver" as const,
                            icon: User,
                            title: "I'm a driver",
                            desc: "I drive for a hauling company and need to check in, upload tickets, and report status.",
                          },
                          ...
                          <div
                            ...
                            tabIndex={0}
                            className={`border-2 p-6 rounded-xl cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                              field.value === value
                          ...
                          >
                            <Icon
                              className={`w-8 h-8 mb-4 ${field.value === value ? "text-primary" : "text-muted-foreground"}`}
                              aria-hidden="true"
                            />
