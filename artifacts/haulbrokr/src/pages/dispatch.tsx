                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="font-mono text-xs text-muted-foreground">JOB-{String(job.id).padStart(4, "0")}</span>
                          <StatusChip status={job.status} />
                        </div>
                        <p className="font-semibold capitalize">{job.materialType} Haul</p>
                      ...
                      <div className="text-right text-sm">
                        {job.position ? (
                          ...
                          <span className="text-muted-foreground">Awaiting GPS</span>
                        )}
                        {job.position && (
                          <p className="text-xs text-muted-foreground mt-1">
                            {job.position.lat.toFixed(4)}, {job.position.lng.toFixed(4)}
                          </p>
                        )}
                      </div>
                    </div>
