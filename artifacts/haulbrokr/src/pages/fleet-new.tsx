...
const formSchema = z.object({
  ...
  coiStatus: z
    .nativeEnum(TruckInputCoiStatus)
    .default(TruckInputCoiStatus.none),
...
export default function NewTruckPage() {
  ...
  const { data: existing, isLoading: loadingTruck } = useGetTruck(
    truckId as number,
    {
  ...
  useEffect(() => {
    if (isEdit && existing) {
      reset({
        ...
        vin: existing.vin ?? "",
        coiStatus: (existing.coiStatus ??
          TruckInputCoiStatus.none) as TruckInputCoiStatus,
  ...
  function onSubmit(values: FormValues) {
    ...
    if (isEdit) {
      updateTruck.mutate(
        { id: truckId as number, data: values },
        { onSuccess, onError },
      );
    } else {
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          placeholder="20"
                          {...field}
                          className="h-12 border-2 rounded-xl focus-visible:ring-primary font-mono text-lg"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input
                            ...
                            placeholder="110"
                            {...field}
                            className="h-12 pl-8 border-2 rounded-xl focus-visible:ring-primary font-mono text-lg"
                          />
                        </div>
                      </FormControl>
                      <FormDescription>
                        Your baseline rate. You can adjust this per bid.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="e.g. 27"
                          {...field}
                          className="h-12 border-2 rounded-xl focus-visible:ring-primary font-mono"
                        />
                      </FormControl>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="h-12 border-2 rounded-xl focus-visible:ring-primary uppercase font-mono"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          placeholder="Kenworth, Peterbilt..."
                          {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Input
                          placeholder="Driver name, specific equipment..."
                          {...field}
                          className="h-12 border-2 rounded-xl focus-visible:ring-primary"
                        />
                      </FormControl>
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-xl border-2 p-4 bg-muted/20">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      Turn this off if the truck is in the shop or on a
