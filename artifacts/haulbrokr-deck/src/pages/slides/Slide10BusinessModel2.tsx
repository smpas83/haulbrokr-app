    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2vh" }}>
            ...
            >
              ...
              <span style={{ fontSize: "1.2vw", color: "#A0785A" }}>
                $127.50
              </span>
            </div>
            <div
            ...
            >
              <span
                style={{ fontSize: "1.4vw", fontWeight: 500, color: "#FFFFFF" }}
              >
                Net contribution per job
              </span>
              <span
                style={{ fontSize: "1.6vw", fontWeight: 500, color: "#A0785A" }}
              >
                $110
              </span>
            </div>
        ...
        >
          ...
          <div
            style={{ display: "flex", flexDirection: "column", gap: "3.5vh" }}
          >
            <div>
              <div
                style={{
          ...
          >
            <div style={{ fontSize: "1vw", color: "#888888", lineHeight: 1.6 }}>
              At 15,000 operators averaging 3 jobs/week, the platform generates
              over $48M annual net contribution before SaaS and embedded finance
              revenue.
            </div>
          </div>
        </div>
