      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <span style={{ fontSize: "1.2vw", color: "#FFFFFF", flex: 1 }}>
              Founders (retained)
            </span>
            <span
              style={{ fontSize: "1.5vw", fontWeight: 300, color: "#FFFFFF" }}
            >
              80%
            </span>
          </div>
          ...
          >
            ...
            />
            <span style={{ fontSize: "1.2vw", color: "#888888", flex: 1 }}>
              CTO Partner
            </span>
            <span
              style={{ fontSize: "1.5vw", fontWeight: 300, color: "#f5c842" }}
            >
              5%
            </span>
          </div>
          ...
          >
            ...
            <span
              style={{ fontSize: "1.5vw", fontWeight: 300, color: "#d4820a" }}
            >
              5%
            </span>
          </div>
          ...
          >
            ...
            <span
              style={{ fontSize: "1.5vw", fontWeight: 300, color: "#e9a600" }}
            >
              5%
            </span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "2vw" }}>
            ...
            <span
              style={{ fontSize: "1.5vw", fontWeight: 300, color: "#fde68a" }}
            >
              5%
            </span>
          </div>
