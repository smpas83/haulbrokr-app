...
export const ListRequestsResponseItem = zod.object({
  ...
  "facilityCoordinates": zod.string().nullish(),
  "facilityInstructions": zod.string().nullish(),
  "facilityAcceptedMaterials": zod.string().nullish(),
  "facilitySafetyNotes": zod.string().nullish(),
  "facilityOperatingHours": zod.string().nullish(),
  "facilityPricingMetadata": zod.string().nullish(),
  "facilityPhone": zod.string().nullish(),
  "brokerNotes": zod.string().nullish(),
  "driverInstructions": zod.string().nullish(),
  "notes": zod.string().nullish(),
...
export const CreateRequestBody = zod.object({
  ...
  "facilityCoordinates": zod.string().optional().describe('Facility coordinates as \"lat,lng\" when supplied by a maps client.'),
  "facilityInstructions": zod.string().optional(),
  "facilityAcceptedMaterials": zod.string().optional(),
  "facilitySafetyNotes": zod.string().optional(),
  "facilityOperatingHours": zod.string().optional(),
  "facilityPricingMetadata": zod.string().optional(),
  "facilityPhone": zod.string().optional(),
  "brokerNotes": zod.string().optional(),
  "driverInstructions": zod.string().optional(),
  "notes": zod.string().optional()
})
...
export const UpdateRequestBody = zod.object({
  ...
  "facilityId": zod.number().optional(),
  "facilityName": zod.string().optional(),
  "facilityCoordinates": zod.string().optional(),
  "facilityInstructions": zod.string().optional(),
  "facilityAcceptedMaterials": zod.string().optional(),
  "facilitySafetyNotes": zod.string().optional(),
  "facilityOperatingHours": zod.string().optional(),
