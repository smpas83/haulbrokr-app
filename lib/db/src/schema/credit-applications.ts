...
export const creditApplicationsTable = pgTable("credit_applications", {
  ...
  estimatedMonthlySpend: numeric("estimated_monthly_spend", {
    precision: 12,
    scale: 2,
  }),
...
export const insertCreditApplicationSchema = createInsertSchema(
  creditApplicationsTable,
).omit({ id: true, createdAt: true, updatedAt: true, status: true });
export type InsertCreditApplication = z.infer<
  typeof insertCreditApplicationSchema
>;
