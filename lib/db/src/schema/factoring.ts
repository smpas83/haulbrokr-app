...
export const factoringStatusEnum = pgEnum("factoring_status", [
  "pending",
  "approved",
  "funded",
  "settled",
...
export const insertFactoringRequestSchema = createInsertSchema(
  factoringRequestsTable,
).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertFactoringRequest = z.infer<
  typeof insertFactoringRequestSchema
>;
