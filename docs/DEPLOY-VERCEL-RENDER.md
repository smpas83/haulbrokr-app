...
7. If your Render service name differs from `haulbrokr-api`, update the rewrite URL in `artifacts/haulbrokr/vercel.json`.
...
ASC App ID `6769841431` is in `eas.json`.
